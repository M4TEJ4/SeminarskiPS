...
public class AzurirajTreningSaTreneromSO extends ApstraktnaGenerickaOperacija {

    @Override
    protected void preduslovi(Object param) throws Exception {
        if (param == null || !(param instanceof TreningSaTrenerom)) {
            throw new Exception("Sistem ne može da ažurira trening sa trenerom: neispravan objekat.");
        }
    ...
    protected void izvrsiOperaciju(Object param, String kljuc) throws Exception {
        broker.edit((TreningSaTrenerom) param);
    }
}
