...
public class AzurirajSamostalanTreningSO extends ApstraktnaGenerickaOperacija {

    @Override
    protected void preduslovi(Object param) throws Exception {
        if (param == null || !(param instanceof SamostalanTrening)) {
            throw new Exception("Sistem ne može da ažurira samostalan trening: neispravan objekat.");
        }
    ...
    protected void izvrsiOperaciju(Object param, String kljuc) throws Exception {
        broker.edit((SamostalanTrening) param);
    }
}
